...
DEFINE_BITFIELD(organ_flags, list(
	...
	"ORGAN_NO_DISMEMBERMENT" = ORGAN_NO_DISMEMBERMENT, // BLUEMOON ADD
	"ORGAN_EDIBLE" = ORGAN_EDIBLE, // BLUEMOON ADD
	"ORGAN_SYNTHETIC_EMP" = ORGAN_SYNTHETIC_EMP, // BLUEMOON ADD
))
...
DEFINE_BITFIELD(slot_flags, list(
	...
	//BLUEMOON EDIT ADDITION BEGIN
	"ITEM_SLOT_SHOULDERS" = ITEM_SLOT_SHOULDERS,
	//BLUEMOON EDIT ADDITION END
