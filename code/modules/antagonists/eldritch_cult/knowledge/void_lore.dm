/datum/eldritch_knowledge/base_void
	...
	desc = "Opens up the path of void to you. Allows you to transmute a shiv (glass shard + cloth) in a sub-zero temperature into a void blade."
	...
	required_atoms = list(/obj/item/kitchen/knife/shiv)
