/datum/eldritch_knowledge/base_ash
	...
	desc = "Inducts you into the Path of Ash. Allows you to transmute a match with a shiv (glass shard + cloth) into an ashen blade."
	...
	required_atoms = list(/obj/item/kitchen/knife/shiv,/obj/item/match)
