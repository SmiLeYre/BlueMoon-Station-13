/datum/eldritch_knowledge/base_flesh
	...
	desc = "Inducts you into the Path of Flesh. Allows you to transmute a pool of blood with a shiv (glass shard + cloth) into a Blade of Flesh."
	...
	required_atoms = list(/obj/item/kitchen/knife/shiv,/obj/effect/decal/cleanable/blood)
