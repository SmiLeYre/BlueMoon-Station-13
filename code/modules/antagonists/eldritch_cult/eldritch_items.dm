...
/obj/item/melee/rune_knife/examine(mob/user)
	. = ..()
	. += "Им можно вырезать 'Резьбу опасности' - почти невидимую руну, которая, если на нее наступить, дает вам подсказку о том, где кто-то стоял на ней и кто это был, и не разрушается, если на нее наступить."
	. += "Им можно вырезать 'Резьбу засады' - если наступить на ее, она нанесет тяжелый урон ногам и оглушит на 5 секунд."
