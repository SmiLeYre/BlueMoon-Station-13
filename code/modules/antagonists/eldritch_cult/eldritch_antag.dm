...
/datum/antagonist/heretic/greet()
	...
	to_chat(owner, "<span class='cult'>Книга шепчет мне, её запретные знания вновь начали появились в этом мире!<br>\
	Книга позволит мне исследовать новые способности. Нужно читать очень внимательно, ибо то что сделно уже не вернуть!<br>\
...
/datum/antagonist/heretic/roundend_report()
	...
	parts += "<b>SСовершённые жертвоприношения:</b>"
