...
/datum/antagonist/bloodsucker/greet()
	...
	bloodsucker_greet += "<span class='boldannounce'>* Будучи бессмертным существом, ваша сила зависит от поколения. Чтобы повысить его, нужно пережидать солнечные вспышки в гробу. Становитесь сильнее, чтобы открывать в себе новые способности...<span><br>"
