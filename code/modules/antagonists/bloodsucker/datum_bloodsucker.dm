...
/datum/antagonist/bloodsucker/greet()
	...
	bloodsucker_greet += "<span class='announce'>Подсказка: Бойся света дня! Солнечные вспышки периодически достигают станции. Единственное спасение от них - твой гроб и шкафы.</span><br>"
