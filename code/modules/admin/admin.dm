...
/datum/admins/proc/dynamic_mode_options(mob/user)
	var/dat = {"
		...
		<br/>BLUEMOON ADDTINIO - Light dynamic, which forbids spawn of team antags. <br/>
		<br/>
		<b>Team based:</b> - Option is <a href='?src=[REF(src)];[HrefToken()];f_teambased_dynamic=1'> <b>[GLOB.teambased_dynamic ? "ON" : "OFF"]</b></a>.
		<br/>BLUEMOON ADDTINIO - Dynamic will only roll team antags (as well as most of ghost antags). <br/>
		<br/>
