...
/obj/item/clothing/accessory/padding
	...
	icon_state = "padding"
	armor = list(MELEE = 10, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 5, BIO = 0, RAD = 0, FIRE = -20, ACID = 45)
...
/obj/item/clothing/accessory/kevlar
	...
	icon_state = "padding"
	armor = list(MELEE = 0, BULLET = 10, LASER = 0, ENERGY = 0, BOMB = 10, BIO = 0, RAD = 0, FIRE = 0, ACID = 25)
...
/obj/item/clothing/accessory/plastics
	...
	icon_state = "plastics"
	armor = list(MELEE = 5, BULLET = 0, LASER = 10, ENERGY = 10, BOMB = 0, BIO = 0, RAD = 0, FIRE = 20, ACID = -40)
	flags_inv = HIDEACCESSORY
