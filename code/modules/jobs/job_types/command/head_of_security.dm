...
/datum/outfit/job/hos
	...
	backpack_contents = list(/obj/item/storage/box/sec_kit = 1, /obj/item/modular_computer/tablet/preset/advanced = 1, /obj/item/choice_beacon/hos_new_weapon = 1, /obj/item/stamp/security = 1)
