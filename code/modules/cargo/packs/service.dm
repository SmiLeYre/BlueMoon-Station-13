...
/datum/supply_pack/service/cargo_supples
	...
	desc = "Sold everything that wasn't bolted down? You can get right back to work with this crate containing stamps, an export scanner, destination tagger, hand labeler and some package wrapping. Now with extra toner cartidges!Продал все, что не было прикручено? Вы можете сразу вернуться к работе с этим ящиком, содержащим марки, экспортный сканер, устройство для маркировки места назначения, ручную этикетировочную машину и некоторые виды упаковки. Теперь с дополнительными картриджами с тонером!"
	cost = 1000
...
/datum/supply_pack/service/snowmobile
	name = "Snowmobile kit"
	desc = "Пойманный в ловушку на холодной пустоши? нужно быстро передвигаться? приобретите отремонтированный снегоход с бесплатной гарантией 10 микросекунд!"
...
/datum/supply_pack/service/grill
	...
	desc = "Эй, пап, я голоден. Привет, Голодный, Я НОВЫЙ СТАРТОВЫЙ НАБОР ДЛЯ ГРИЛЯ, ПОЛУЧИ СЕЙЧАС ВСЕГО 3000 БАКСОВ! Содержит гриль для приготовления пищи и пять листов топливного угля."
	cost = 3000
...
/datum/supply_pack/service/cutlery
	...
	desc = "Нужно нарезать кубиками эти \"помидоры\"? Что ж, у нас есть то, что вам нужно! В комплекте хороший набор ножей, вилок, тарелок, стаканов и точильнй камень."
	cost = 10000
	contraband = TRUE
