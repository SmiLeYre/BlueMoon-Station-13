...
/datum/supply_pack/engine/am_shielding
	...
	desc = "Содержит девять деталей антиматерии, каким-то образом втиснутых в ящик."
	cost = 2500
...
/datum/supply_pack/engine/field_gen
	...
	desc = "Обычно это единственное, что стоит между станцией и грязной смертью. Питается от эммитеров. Содержит два генератора поля."
	cost = 1750
...
/datum/supply_pack/engine/PA
	...
	desc = "Сверхмассивная Сингулярность или сверхмощный шар Тесла - идеальный способ оживить любую вечеринку! Этот набор \"Мой первый апокалипсис\" содержит все, что вам нужно, чтобы построить свой собственный ускоритель частиц! Возрастное ограничение от 10 лет и старше."
	cost = 3750
...
/datum/supply_pack/engine/collector
	...
	desc = "Содержит три радиационных накопителя. Полезно при получении энергии с крисстала Суперматерии или Сингулярности"
	cost = 2750
...
/datum/supply_pack/engine/solar
	...
	desc = "Станьте зеленым с этой солнечной батареей. Содержит двадцать одну солнечную панель, печатную плату управления солнечными панелями и трекер. Если у вас есть какие-либо вопросы, пожалуйста, ознакомьтесь с прилагаемой инструкцией."
	cost = 2850
