...
/datum/supply_pack/organic/fakemeat
	...
	desc = "Мясо уже кончилось? Держите ящериц довольными с помощью этой морозильной камеры, наполненной безжалостным химически приготовленным мясом! Содержит 12 кусков мясного продукта и 4 куска *карпа*."
...
/datum/supply_pack/organic/hydroponics/maintgarden
	...
	desc = "Создайте свой собственный крошечный рай с помощью набора для бботаники \"сделай сам\". Содержит песчаник для грунтовых участков, спрей от вредителей, аммиак, портативный генератор семян, основные ботанические инструменты и несколько семян для начала."
	cost = 2700
