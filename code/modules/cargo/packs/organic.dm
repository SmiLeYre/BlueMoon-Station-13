...
/datum/supply_pack/organic/hydroponics/maintgarden
	...
	desc = "Создайте свой собственный крошечный рай с помощью набора для ботаники \"сделай сам\". Содержит песчаник для грунтовых участков, спрей от вредителей, аммиак, портативный генератор семян, основные ботанические инструменты и несколько семян для начала."
	cost = 2700
