...
/datum/unit_test/outfit_sanity/Run()
	...
	for (var/outfit_type in subtypesof(/datum/outfit))
		...
		CHECK_OUTFIT_SLOT(shoulders, ITEM_SLOT_SHOULDERS)
		...
		CHECK_OUTFIT_SLOT(underwear, ITEM_SLOT_UNDERWEAR)
		CHECK_OUTFIT_SLOT(shirt, ITEM_SLOT_SHIRT)
		CHECK_OUTFIT_SLOT(socks, ITEM_SLOT_SOCKS)
		CHECK_OUTFIT_SLOT(wrists, ITEM_SLOT_WRISTS)
		CHECK_OUTFIT_SLOT(ears_extra, ITEM_SLOT_EARS_RIGHT)
