...
*/
			. += "<br>ПОДХОД К ГОЛОСОВАНИЮ В РАЗРАБОТКЕ! (Обновлено 18.08.2023)"
			...
			. += "<h4>Проходит тест-мёрдж (эксперимент) - чередование режимов. Возможность голосовать есть только за тот режим, который не был в прошлом раунде."
