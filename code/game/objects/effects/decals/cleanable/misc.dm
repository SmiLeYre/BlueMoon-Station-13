...
/obj/effect/decal/cleanable/glitter/blue/bluespace_remains
	name = "bluespace dust"
	var/source_x
	var/inaccuracy_x
	var/source_y
...
/obj/effect/decal/cleanable/glitter/blue/bluespace_remains/attackby(obj/item/I, mob/user, params)
	..()
...
/obj/effect/decal/cleanable/glitter/blue/bluespace_remains/Initialize(mapload, sour_x, sour_y, sour_z, sour_owner)
	. = ..()
	if(sour_x)
		source_x = sour_x
