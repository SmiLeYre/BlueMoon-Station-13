...
/obj/item/storage/toolbox/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] robusts себя with [src]! It looks like [user.ru_who()] trying to commit suicide!</span>")
	return (BRUTELOSS)
...
/obj/item/storage/toolbox/mechanical/old/clean // the assistant traitor toolbox, damage scales with CR inside
	name = "toolbox"
