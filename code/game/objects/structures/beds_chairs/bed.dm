...
/obj/structure/bed/roller/post_buckle_mob(mob/living/M)
	// BLUEMOON ADDITION AHEAD - сверх-больших персонажей нельзя помещать на носилки (предотвращает абуз через толкание + повышает значимость боргов, халков и других сверх-тяжёлых персонажей)
