...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_DS1 = FREQ_DS1, //BLUEMOON EDIT ADDITION - MAPPING
	RADIO_CHANNEL_DS2 = FREQ_DS2, //BLUEMOON EDIT ADDITION - MAPPING
	RADIO_CHANNEL_TARKOFF = FREQ_TARKOFF, //BLUEMOON EDIT ADDITION - MAPPING
	RADIO_CHANNEL_PIRATE = FREQ_PIRATE, //BLUEMOON EDIT ADDITION - MAPPING
	RADIO_CHANNEL_SOL = FREQ_SOL, // BlueMoon Kovac added
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_PIRATE]" = RADIO_CHANNEL_PIRATE, //BLUEMOON EDIT ADDITION - MAPPING
	"[FREQ_DS1]" = RADIO_CHANNEL_DS1, //BLUEMOON EDIT ADDITION - MAPPING
	"[FREQ_DS2]" = RADIO_CHANNEL_DS2, //BLUEMOON EDIT ADDITION - MAPPING
	"[FREQ_TARKOFF]" = RADIO_CHANNEL_TARKOFF, //BLUEMOON EDIT ADDITION - MAPPING
	"[FREQ_SOL]" = RADIO_CHANNEL_SOL, //BlueMoon Kovac added
