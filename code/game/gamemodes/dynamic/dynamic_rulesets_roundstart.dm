...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_roles = list("Prisoner", "Shaft Miner", "Lawyer", "Blueshield", "Peacekeeper", "Brig Physician", "NanoTrasen Representative", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Quartermaster", "Chief Engineer", "Chief Medical Officer", "Research Director")
...
/datum/dynamic_ruleset/roundstart/traitorbro
	...
	protected_roles = list("Prisoner", "Shaft Miner", "Lawyer", "Blueshield", "Peacekeeper", "Brig Physician", "NanoTrasen Representative", "Security Officer", "Warden", "Detective", "Head of Security", "Captain")
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Prisoner", "Shaft Miner", "Lawyer", "Blueshield", "Peacekeeper", "Brig Physician", "NanoTrasen Representative", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Chaplain", "Head of Personnel", "Quartermaster", "Chief Engineer", "Chief Medical Officer", "Research Director")
	required_candidates = 2
