...
/datum/ai_laws/syndicate_override/New()
	..()
	set_zeroth_law("В контексте ваших законов 'Агент' является сокращением от 'Агента Синдиката', другие интерпритации неверны. Агентами Синдиката являются лица с соответственным определением в Профессии, БД или при наличии корпоративного бейджа и зания кодового языка.")
...
/datum/ai_laws/nt_override/New()
	..()
	set_zeroth_law("В контексте ваших законов 'Сотрудник НТ' является сокращением от 'Сотрудника НаноТрейзен', другие интерпритации неверны. Сотрудниками НТ являются лица с соответственным определением в Профессии, БД или при наличии корпоративного бейджа и зания корпоративного языка.")
