...
#define JOB_DISPLAY_ORDER_NTR 38
#define JOB_DISPLAY_ORDER_BLUESHIELD 39
#define JOB_DISPLAY_ORDER_BO 40
#define JOB_DISPLAY_ORDER_PRISONER 41 //BlueMoon edit end
#define JOB_DISPLAY_ORDER_STOWAWAY 42 // Сплюрт, сука.
