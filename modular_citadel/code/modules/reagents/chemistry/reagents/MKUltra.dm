...
/datum/reagent/fermi/enthrall
	...
	pH = 10
	chemical_flags = REAGENT_ONMOBMERGE | REAGENT_DONOTSPLIT | REAGENT_ORGANIC_PROCESS // BLUEMOON CHANES - только для органиков //Procs on_mob_add when merging into a human
	can_synth = FALSE
