...
/obj/item/toy/plush/mammal/fox/vulp/bao
	name = "Bao Plushie"
	desc = "Забавная игрушка напоминающая таярку. На задней этикетке видно надпись 'Не подлежит стирки после загрязнения семенными жидкостями.'"
	icon = 'modular_sand/icons/obj/plushes.dmi'
