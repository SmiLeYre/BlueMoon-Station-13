...
/datum/quirk/bluemoon_heavy_super
	...
	Вы перемещаетесь так, как будто максимального допустимого роста для работы на космической станции (ослабление скорости до 200% размера персонажа). \
	Вас могут тянуть только киборги, некоторые мехи и такие же сверх-тяжёлые члены экипажа. \
