/obj/item/gun/energy/e_gun/erotaser
	...
	icon_state = "erotaser"
	item_state = "erotaser"
	lefthand_file = 'modular_bluemoon/lewd_armory/icons/mob/inhands/weapons/ero_disabler_lefthand.dmi'
	righthand_file = 'modular_bluemoon/lewd_armory/icons/mob/inhands/weapons/ero_disabler_righthand.dmi'
