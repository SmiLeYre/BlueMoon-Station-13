/obj/effect/spawner/lootdrop/trader/hardsuit
	name = "hardsuit product"
	lootcount = 10
	loot = list(
...
/obj/effect/spawner/lootdrop/trader/armor
	name = "armor product"
	lootcount = 15
	loot = list(
...
/obj/effect/spawner/lootdrop/trader/helmet
	name = "helmet product"
	lootcount = 15
	loot = list(
			...
			/obj/item/clothing/head/helmet/hephaestus = 3,
...
/obj/effect/spawner/lootdrop/trader/weapons
	...
	loot = list(
			...
			/obj/item/gun/energy/pulse/pistol = 0.01,
