...
/mob/living/simple_animal/hostile/retaliate/poison/terror_spider/healer
	...
	special_abillity = list(/obj/effect/proc_holder/spell/aoe_turf/terror_healing)
	...
	var/datum/action/terrorspider/greeneggs/greeneggs_action
...
/mob/living/simple_animal/hostile/retaliate/poison/terror_spider/healer/spider_specialattack(mob/living/carbon/human/L, poisonable)
	...
	if(L.IsStun() || L.can_inject(null, FALSE, inject_target, FALSE))
		L.adjust_blurriness(20 SECONDS, 0, 120 SECONDS)
