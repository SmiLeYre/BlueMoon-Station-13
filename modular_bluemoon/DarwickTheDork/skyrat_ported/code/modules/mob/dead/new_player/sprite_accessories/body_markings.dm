...
/datum/sprite_accessory/insect_fluff/neckfluff/mutcolors
	name = "Neckfluff (Primary)"
	color_src = MUTCOLORS

/datum/sprite_accessory/insect_fluff/neckfluff/mutcolors2
	name = "Neckfluff (Secondary)"
	color_src = MUTCOLORS2

/datum/sprite_accessory/insect_fluff/neckfluff/mutcolors3
	name = "Neckfluff (Tertiary)"
