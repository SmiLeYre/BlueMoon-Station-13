...
/datum/action/bloodsucker/tutorial/ActivatePower()
	...
	bloodsucker_tutorial += span_userdanger("<br><center>Гроб, поколения, фаза дня</center><br>")
	bloodsucker_tutorial += span_danger("* Поколение повышается с каждым пережитым днём.<br>")
	bloodsucker_tutorial += span_danger("* Твои предшественники разгневали Его, что ангелы обрекли тебя и других сородичей скитаться ночью, спасаясь от света звёзд. Спастись днём можно в гробу или шкафу.<br>")
	...
	bloodsucker_tutorial += span_danger("* Каждое повышение своего поколения дарует тебе больше сил. Ты можешь вынести больше повреждений, а твои руки становятся сильнее, чтобы можно было представлять угрозу еде даже безоружным.<br>")
	...
	bloodsucker_tutorial += span_danger("* Чтобы обратить кого-то в своего раба, необходимо привести жертву к алтарю (который был заранее установлен в убежище через меню крафта). \
