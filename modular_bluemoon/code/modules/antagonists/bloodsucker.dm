...
/datum/action/bloodsucker/tutorial/ActivatePower()
	...
	bloodsucker_tutorial += span_danger("* Поколение повышается при сне в гробу днём.<br>")
	...
	bloodsucker_tutorial += span_danger("* Твои предшественники разгневали Его, что ангелы обрекли тебя и других сородичей скитаться ночью, спасаясь от света звёзд.<br>")
	bloodsucker_tutorial += span_danger("* Чем выше твоё поколение, тем сильнее твоя кожа будет гореть под лучами солнца. Все окружающие заметят, что даже будучи ничтожным неонатом, на тебе внезапно появляются ожоги.<br>")
