...
/datum/action/bloodsucker/tutorial/ActivatePower()
	...
	bloodsucker_tutorial += "<div class='info'>"
	...
	bloodsucker_tutorial += span_userdanger("<br><center>Логово, гроб, фаза дня</center><br>")
	...
	bloodsucker_tutorial += span_danger("* Если кто-то стоит на расстоянии двух метров в момент начала, то они заметят, что ты кормишься. Не стоит делать это в многолюдных местах.<br>")
