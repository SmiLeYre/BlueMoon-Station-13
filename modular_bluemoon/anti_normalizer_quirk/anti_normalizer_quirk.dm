/datum/quirk/anti_normalizer
	...
	По тем или иным причинам, на вас эта технология не работает."
	value = 0
	...
	medical_record_text = "Пациент обладает параметрами, которые делают его неподходящим кандидатом для нормалайзеров от Syntech."
